...
function OmxDBus(address) {
  ...
  omxdbus_id = omxdbus_id < 100 ? omxdbus_id++ : 50;

}

util.inherits(OmxDBus, EventEmitter);
OmxDBus.prototype.openPlayer = openPlayer;

OmxDBus.prototype.addBalance = function(amount) {
...
//       bus.invoke({
//         path: '/org/mpris/MediaPlayer20',
//         interface: 'org.freedesktop.DBus.Properties',
//         member: prop,
//         destination: 'org.mpris.MediaPlayer20.omxplayer'
//       }, function(err, resp) {
//         return cb(err, resp);
//       });
//     } else {
...
//       bus.invoke({
//         path: '/org/mpris/MediaPlayer20',
//         interface: 'org.mpris.MediaPlayer20.Player',
//         member: prop,
//         destination: 'org.mpris.MediaPlayer20.omxplayer',
